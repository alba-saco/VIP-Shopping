...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab1-tab1-module"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppTab1Tab1PageHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<ion-header [translucent]=\"true\">\n  <ion-toolbar>\n    <ion-title>\n      Item Query\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content [fullscreen]=\"true\">\n  <ion-header collapse=\"condense\">\n    <ion-toolbar>\n      <ion-title size=\"large\">Tab 1</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <div class=\"search\">\n    <form (ngSubmit)=\"submit()\">\n      <ion-item>\n        <ion-label>Search for items</ion-label>\n        <ion-input type=\"text\" [(ngModel)]=\"search\" name=\"search\"></ion-input>\n      </ion-item>\n        <button ion-button type=\"submit\" block>Search</button>\n    </form>\n  </div>\n\n  <div *ngIf = \"directions.length > 0\" class=\"directions\">\n    {{items[0].color}} {{items[0].material}} {{items[0].category}} <br>\n    {{items[0].price}}\n    <div *ngFor = \"let step of directions\">\n      {{step}}\n    </div>\n  </div>\n\n</ion-content>\n";
    /***/
  },
  ...
  function srcAppTab1Tab1PageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _querying_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../querying.service */
    "./src/app/querying.service.ts");

    var Tab1Page = /*#__PURE__*/function () {
      function Tab1Page(queryingService) {
      ...
      _createClass(Tab1Page, [{
        ...
        value: function query(search) {
          ...
          this.queryingService.postSearch(search).subscribe(function (response) {
            _this.items = response;
            _this.searchNode = _this.items[0].node;

            _this.queryingService.navigate(_this.searchNode).subscribe(function (instructions) {
              _this.directions = instructions;
            });
          });
        }
      }]);
    ...
    Tab1Page.ctorParameters = function () {
      return [{
        type: _querying_service__WEBPACK_IMPORTED_MODULE_2__["QueryingService"]
      }];
    };
